...
INSERT INTO
  customers (first_name, last_name, gender, phone_no)
VALUES
  ('Chris', 'Martin', 'MALE', '1123147789'),
  ('Emma', 'Law', 'FEMALE', '1123439899'),
  ('Mark', 'Watkins', 'MALE', '117459213'),
  ('Daniel', 'Williams', 'MALE', NULL),
  ('Sarah', 'Taylor', 'FEMALE', '117634829'),
  ('Katie', 'Armstrong', 'FEMALE', '1145787353'),
  ('Michael', 'Bluth', 'MALE', '198289282'),
  ('Kat', 'Nash', 'FEMALE', '1176987789'),
  ('Buster', 'Bluth', 'MALE', '1173456782'),
  ('Charlie', NULL, 'FEMALE', '1139287883'),
  ('Lindsay', 'Bluth', 'FEMALE', '117692384'),
  ('Harry', 'Johnson', 'MALE', NULL),
  ('John', 'Smith', 'MALE', '1174987221'),
  ('John', 'Taylor', 'MALE', NULL),
  ('Emma', 'Smith', 'FEMALE', '1176984116'),
  ('Gob', 'Bluth', 'MALE', '1176985498'),
  ('George', 'Bluth', 'MALE', '117698433'),
  ('Lucille', 'Bluth', 'FEMALE', '1198773214'),
  ('George', 'Evans', 'MALE', '117452933'),
  ('Emily', 'Simmonds', 'FEMALE', '1899284352'),
  ('John', 'Smith', 'MALE', '114447333'),
  ('Jennifer', NULL, 'FEMALE', NULL),
  ('Toby', 'West', 'MALE', '11769822'),
  ('Paul', 'Edmonds', 'MALE', '1966947113');

-- Inserting into order table
INSERT INTO
  orders (product_id, customer_id, order_time)
VALUES
